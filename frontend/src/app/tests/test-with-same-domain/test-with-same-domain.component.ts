...
@Component({
  selector: 'app-test-with-same-domain',
  templateUrl: './test-with-same-domain.component.html',
  styleUrls: ['./test-with-same-domain.component.scss']
})
export class TestWithSameDomainComponent implements OnInit {
  ...
  getTests(id: number): void {
    this.testService.getTestWithSameDomain(id).subscribe(data => {
